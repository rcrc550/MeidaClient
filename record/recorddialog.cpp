...
void RecordDialog::slot_Process(qint64 min, qint64 max)
{
    ui->pgb_set->setMaximum( max);
    ui->pgb_set->setValue( min );
}
void RecordDialog::on_pb_commit_clicked()
{
    Q_EMIT SIG_COMMIT_FILE(m_savePath);
}
